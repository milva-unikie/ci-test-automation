...
Set Variables
    ...
    Set Global Variable  ${GHAF_HOST}          ghaf-host
    ...
    Set Global Variable  @{VMS}                ${ADMIN_VM}  ${AUDIO_VM}  ${BUSINESS_VM}  ${CHROME_VM}  ${COMMS_VM}  ${GALA_VM}  ${GHAF_HOST}  ${GUI_VM}  ${NET_VM}  ${ZATHURA_VM}
