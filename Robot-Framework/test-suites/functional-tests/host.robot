...
Test ghaf version format
    ...
    [Tags]             pre-merge   SP-T54  nuc  orin-agx  orin-agx-64  orin-nx  riscv  lenovo-x1   dell-7330  fmo
...
Test nixos version format
    ...
    [Tags]             pre-merge   SP-T55  nuc  orin-agx  orin-agx-64  orin-nx  riscv  lenovo-x1   dell-7330  fmo
    Verify Nixos Version Format

Check QSPI version
    [Documentation]    QSPI version should be up-to-date
    [Tags]             pre-merge  SP-T95  orin-agx  orin-agx-64  orin-nx
    Check QSPI Version is up to date

Check systemctl status
    [Documentation]    Verify systemctl status is running on host
    [Tags]             pre-merge  SP-T98  nuc  orin-agx  orin-agx-64  orin-nx  riscv  lenovo-x1   dell-7330  fmo
...
Check Memory status
    ...
    [Tags]           lenovo-x1   dell-7330  SP-5321  fmo
