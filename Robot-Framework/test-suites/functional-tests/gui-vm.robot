...
Start Calculator on LenovoX1
    ...
    [Tags]            bat   calculator  SP-T202  lenovo-x1   dell-7330  fmo
...
Start Sticky Notes on LenovoX1
    ...
    [Tags]            bat   sticky_notes  SP-T201-1  lenovo-x1   dell-7330  fmo
...
Start Ghaf Control Panel on LenovoX1
    ...
    [Tags]            bat   control_panel  SP-T205  lenovo-x1   dell-7330  fmo
...
Start Bluetooth Settings on LenovoX1
    ...
    [Tags]            bat   bluetooth_settings  SP-T204  lenovo-x1   dell-7330  fmo
...
Start COSMIC Files on LenovoX1
    ...
    [Tags]            bat   cosmic_files  SP-T206  lenovo-x1   dell-7330  fmo
    IF  $COMPOSITOR == 'cosmic'
...
Start COSMIC Settings on LenovoX1
    ...
    [Tags]            bat   cosmic_settings  SP-T254  lenovo-x1   dell-7330  fmo
    IF  $COMPOSITOR == 'cosmic'
...
Start COSMIC Text Editor on LenovoX1
    ...
    [Tags]            bat   cosmic_editor  SP-T243  lenovo-x1   dell-7330  fmo
    IF  $COMPOSITOR == 'cosmic'
