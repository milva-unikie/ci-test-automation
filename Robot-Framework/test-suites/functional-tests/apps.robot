...
Start Element on LenovoX1
    ...
    [Tags]            bat  regression  pre-merge   SP-T52   lenovo-x1   dell-7330
    Connect to netvm
...
Start Slack on LenovoX1
    ...
    [Tags]            bat  regression  pre-merge   SP-T181   lenovo-x1   dell-7330
    Connect to netvm
    Check if ssh is ready on vm    ${COMMS_VM}
    Connect to VM          ${GUI_VM}   ${USER_LOGIN}   ${USER_PASSWORD}
...
Open PDF with Zathura
    ...
    [Tags]             bat  regression  pre-merge   SP-T131   lenovo-x1   dell-7330
    Connect to netvm
    Connect to VM      ${CHROME_VM}
...
Open image with Oculante
    ...
    [Tags]             bat  regression  pre-merge   SP-T197   lenovo-x1   dell-7330
    Connect to netvm
    Connect to VM           ${GUI_VM}   ${USER_LOGIN}   ${USER_PASSWORD}
